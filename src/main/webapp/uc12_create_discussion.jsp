...
<body>
    ...
    <div class="header">
        ...
        <div class="nav-right">
            <a href="uc12_forum_welcome.jsp" style="color: #0d4e57; font-weight: 600;">Forum</a>
    ...
    <!-- Container -->
    <div class="container">
        <a href="uc12_forum_detail.jsp" class="back-btn">← Back</a>
            ...
            <form id="discussionForm" onsubmit="handleSubmit(event)">
                <div class="form-inner">
                    ...
                    <div class="button-group">
                        <button type="button" class="cancel-btn" onclick="window.location.href='uc12_forum_detail.jsp'">[Cancel]</button>
    ...
    <div class="modal" id="successModal">
        <div class="modal-content">
            ...
            <button class="modal-btn" onclick="window.location.href='uc12_forum_detail.jsp'">Return to Forum</button>
        </div>
    </div>
    ...
    <a href="uc10_chatbot.jsp" class="chat-button">
        <img src="images/chatbot.png" alt="Chat with AI">
    </a>
</body>
</html>
