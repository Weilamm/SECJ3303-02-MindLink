...
<body>
    ...
    <div class="container">
        <!-- Back + Title row -->
        <div class="top-row">
            <button class="back-btn" onclick="window.location.href='uc12_forum_joined.jsp'">←</button>
        ...
        <div style="margin-bottom: 32px;">
            <div class="section-header">
                ...
                <a href="uc12_create_discussion.jsp" class="new-discussion-btn">+ New Discussion</a>
            </div>
    ...
    <a href="uc10_chatbot.jsp" class="chat-button">
        <img src="images/chatbot.png" alt="Chat" class="chat-button-icon">
    </a>
    <script>
