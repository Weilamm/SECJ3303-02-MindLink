...
<head>
    ...
    <title>MindLink - Emotional Awareness and Regulation</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <%
        ...
        if (moduleId == null) moduleId = "2";
        
        String moduleTitle = "Emotional Awareness and Regulation";
        String moduleDescription = "Recognize your emotions, understand their causes, and develop healthy strategies to manage them effectively in daily and social situations.";
    %>
        ...
        <main class="main-content">
            ...
            <div class="module-header">
                <img 
                    ...
                    alt="<%= moduleTitle %>" 
                    class="module-image"
                    onerror="this.src='https://via.placeholder.com/250x180/2c5f5d/ffffff?text=Emotional+Awareness'"
                >
            ...
            <section class="chapter-section">
                <h3 class="chapter-title">Chapter 1: Understanding Emotions</h3>
                <div class="lessons-list">
                    ...
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_1.2">
                        <span class="lesson-title">
                            1.2 Primary vs Secondary Emotions
                            <span class="pdf-badge">PDF</span>
                        </span>
                        <button class="mark-done-btn" onclick="markAsDone(this)">Mark as Done</button>
                    </div>
            ...
            <!-- Chapter 2 -->
            <section class="chapter-section">
                <h3 class="chapter-title">Chapter 2: Emotional Awareness</h3>
                <div class="lessons-list">
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_2.1">
                        <span class="lesson-title">
                            2.1 Identifying Your Emotions
                            <span class="pdf-badge">PDF</span>
                        </span>
                        <button class="mark-done-btn" onclick="markAsDone(this)">Mark as Done</button>
                    </div>
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_2.2">
                        <span class="lesson-title">
                            2.2 Body Signals and Emotional Cues
                            <span class="pdf-badge">PDF</span>
                        </span>
                        <button class="mark-done-btn" onclick="markAsDone(this)">Mark as Done</button>
                    </div>
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_2.3">
                        <span class="lesson-title">
                            2.3 Emotional Triggers and Patterns
                            <span class="pdf-badge">PDF</span>
                        </span>
                        <button class="mark-done-btn" onclick="markAsDone(this)">Mark as Done</button>
                    </div>
            ...
            <!-- Chapter 3 -->
            <section class="chapter-section">
                <h3 class="chapter-title">Chapter 3: Emotion Regulation Strategies</h3>
                <div class="lessons-list">
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_3.1">
                        <span class="lesson-title">
                            3.1 Healthy Coping Mechanisms
                            <span class="pdf-badge">PDF</span>
                        </span>
                        <button class="mark-done-btn" onclick="markAsDone(this)">Mark as Done</button>
                    </div>
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_3.2">
                        <span class="lesson-title">
                            3.2 Breathing Techniques and Grounding
                            <span class="pdf-badge">PDF</span>
                        </span>
                        <button class="mark-done-btn" onclick="markAsDone(this)">Mark as Done</button>
                    </div>
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_3.3">
                        <span class="lesson-title">
                    ...
                    <div class="lesson-item" data-lesson="module<%= moduleId %>_3.4">
                        <span class="lesson-title">
                            3.4 Emotional Expression in Relationships
                            <span class="pdf-badge">PDF</span>
                        </span>
                        <button class="mark-done-btn" onclick="markAsDone(this)">Mark as Done</button>
                    </div>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            console.log('Question2 page loaded, fetching completed lessons...');
