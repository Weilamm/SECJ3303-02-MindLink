...
<head>
    ...
    <title>MindLink - Admin Profile</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<%
    // Admin sample data
    String fullName = "Admin Tan";
    String adminId = "ADM001";
    String age = "35"; // optional
    String email = "admin@mindlink.com";
    String phone = "+60112223344";
    ...
    <header>
        <div class="header-content">
            ...
            <nav>
                ...
                <a href="adminmodule.jsp" class="nav-link">Learning</a>
                <a href="forum.jsp" class="nav-link">Forum</a>
                <a href="adminprofile.jsp" class="nav-link active">Profile</a>
        ...
        <div class="profile-card">
            <div class="profile-header">
                <div class="profile-image-container">
                    <img src="images/admin-avatar.jpg" alt="Admin Picture" class="profile-image"
                         onerror="this.src='https://via.placeholder.com/150/4ac1c0/ffffff?text=AT'">
                </div>
            ...
            <div class="profile-details">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value" id="displayAdminId"><%= adminId %></span>
                </div>
                <div class="detail-item">
...
<div class="modal" id="editModal">
    <div class="modal-content">
        ...
        <form id="editForm" onsubmit="saveProfile(event)">
            ...
            <div class="form-group">
                <label class="form-label" for="editAdminId">Admin ID</label>
                <input type="text" class="form-input" id="editAdminId" value="<%= adminId %>" readonly>
            </div>
            <div class="form-group">
