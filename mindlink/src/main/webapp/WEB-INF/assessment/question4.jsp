...
<body>
        ...
        <div class="container">
            <div class="question">
                <h4>Have you sought professional help before?</h4>
                ...
                <div class="animateImage">
                    <img src="animate3.png" alt="animatePicture">
                </div>
                ...
                <div class="previous"> 
                    <form action="question3.jsp" method="post">
                        <button type="submit" class="previous-btn">
                            <img src="previousArrow.png" alt="previousQuestion">
                        </button>
                    </form>                     
                </div>
                <div class="next"> 
