...
<body>
    ...
    <div class="container">
        ...
        <div id="badgeModal" style="display:none; position:fixed; z-index:1000; left:0; top:0; width:100%; height:100%; background:rgba(0,0,0,0.8); align-items:center; justify-content:center;">
            <div style="background:white; padding:40px; border-radius:20px; text-align:center; max-width:400px; box-shadow: 0 5px 15px rgba(0,0,0,0.5);">
                ...
                <div style="border-top: 1px solid #eee; padding-top:20px;">
                    <p style="font-size:0.9rem; color:#013B46;"><strong>Achieved on:</strong> <span id="modalDate"></span></p>
                </div>
