...
<body>
    ...
    <div class="container">
        ...
        <c:forEach items="${modules}" var="module">
            <a href="${pageContext.request.contextPath}/learning/modules/intro?id=${module.moduleId}" class="module-card">
                ...
                <div class="module-content">
                    ...
                    <div class="progress-section">
                        ...
                        <div class="progress-track">
                            <div class="progress-fill" id="progressBar${module.moduleId}" style="width: 0%;"></div>
                        </div>
                        <span class="progress-text" id="progressText${module.moduleId}">0% Completed</span>
                    </div>
                </div>
            </a>
        </c:forEach>
    ...
    <script>
        ...
        window.onload = function() {
            <c:forEach items="${modules}" var="module">
                const savedPercent${module.moduleId} = localStorage.getItem('module_${module.moduleId}_progress_percent') || 0;
                const bar${module.moduleId} = document.getElementById('progressBar${module.moduleId}');
                const text${module.moduleId} = document.getElementById('progressText${module.moduleId}');
                
                if (bar${module.moduleId}) {
                    bar${module.moduleId}.style.width = savedPercent${module.moduleId} + "%";
                }
                if (text${module.moduleId}) {
                    text${module.moduleId}.innerText = savedPercent${module.moduleId} + "% Completed";
                }
            </c:forEach>
        };
    </script>
