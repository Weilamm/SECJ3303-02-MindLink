...
<!-- Header Navigation -->
    ...
    <div class="container">
        <div class="page-header">
            <h2>Students</h2>
            <a href="${pageContext.request.contextPath}/admin/user-management/students/new" class="btn btn-teal">Add New Student</a>
        </div>
                    ...
                    <tbody>
                        <c:forEach items="${students}" var="student">
                            <tr>
                                ...
                                <td>${student.year}</td>
                                <td>${student.createdAt != null ? student.createdAt.toString().substring(0, 16) : 'N/A'}</td>
                                <td>
                        ...
                        <c:if test="${empty students}">
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 40px; color: #888;">No students found.</td>
                            </tr>
                        </c:if>
                    </tbody>
                </table>
