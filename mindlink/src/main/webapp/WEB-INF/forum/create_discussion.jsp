<%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <style>
            * {
            ...
            body {
                ...
                background: #FFE6D0;
                /* soft peach to match forum style */
                min-height: 100vh;
                overflow-x: hidden;
            }
    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="nav-right">
                <a href="${pageContext.request.contextPath}/forum/welcome"
                    style="color: #0d4e57; font-weight: 600;">Forum</a>
        ...
        <!-- Container -->
        <div class="container">
            <a href="${pageContext.request.contextPath}/forum/detail?id=${forumId}" class="back-btn">←</a>
                    ...
                    <div class="form-inner">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" class="form-textarea"
                                placeholder="Share your thoughts, experiences, or questions..." required></textarea>
                        </div>
                        ...
                        <div class="button-group">
                            <button type="button" class="cancel-btn"
                                onclick="window.location.href='${pageContext.request.contextPath}/forum/detail?id=${forumId}'">[Cancel]</button>
        ...
        <div class="modal" id="successModal">
            <div class="modal-content">
                ...
                <button class="modal-btn"
                    onclick="window.location.href='${pageContext.request.contextPath}/forum/detail?id=${forumId}'">Return
                    to Forum</button>
            </div>
        </div>
