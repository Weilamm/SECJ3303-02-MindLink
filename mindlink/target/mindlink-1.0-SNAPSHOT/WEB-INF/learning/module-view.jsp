        ...
        <body>
            ...
            <div class="container">
                ...
                <c:if test="${not empty module}">
                    <div class="header-section">
                        <img src="${pageContext.request.contextPath}/images/${module.imagePath}" class="header-img"
                            alt="${module.title}">
                        <div class="header-content">
                            ...
                            <div class="progress-row">
                                ...
                                <div class="progress-track">
                                    <div class="progress-fill" id="mainProgressBar"
                                        style="width: ${module.progressPercentage}%;"></div>
                                </div>
                                <span id="progressText"
                                    style="font-size: 12px; color: #666;">${module.progressPercentage}% Completed</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="chapter-card">
                ...
                <div class="lesson-row">
                    ...
                    <c:choose>
                        <c:when test="${completedQuestions.contains(question.questionId)}">
                            <button class="btn-status done" style="cursor: default;">DONE</button>
                        </c:when>
                        <c:otherwise>
                            <button class="btn-status pending"
                                onclick="markAsDone(this, ${module.moduleId}, ${question.questionId})">Mark as
                                Done</button>
                        </c:otherwise>
                    </c:choose>
                </div>
            ...
            <script>
                function markAsDone(btn, modId, questionId) {
                    // Optimistic UI Update or Wait for Server? Let's wait for server for accuracy.
                    btn.disabled = true;
                    btn.innerText = "Saving...";

                    // Send POST request
                    fetch('${pageContext.request.contextPath}/learning/modules/progress/save', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded',
                        },
                        body: 'moduleId=' + modId + '&questionId=' + questionId
                    })
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                if (progressBar) {
                                    progressBar.style.width = data.newPercentage + "%";
                                }
                                if (progressText) {
                                    progressText.innerText = data.newPercentage + "% Completed";
                                }
                            } else {
