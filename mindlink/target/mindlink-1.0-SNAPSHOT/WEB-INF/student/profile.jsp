        ...
        <body>
            ...
            <div class="container">
                ...
                <c:if test="${not empty successMessage}">
                    <div
                        style="text-align: center; padding: 15px; background: #e8f5e9; color: #2e7d32; border-radius: 10px; margin-bottom: 20px;">
                        <strong>Success:</strong> ${successMessage}
                    </div>
                </c:if>
                <c:if test="${not empty errorMessage}">
                    <div
                        style="text-align: center; padding: 15px; background: #ffebee; color: #c62828; border-radius: 10px; margin-bottom: 20px;">
                ...
                <div class="profile-layout">
                    ...
                    <div class="details-section">
                        ...
                        <div class="row">
                            ...
                            <span class="value">${student.phone != null && !student.phone.isEmpty() ? student.phone :
                                'Not provided'}</span>
                        </div>
                ...
                <a href="${pageContext.request.contextPath}/profile/edit" class="btn-edit"
                    style="text-decoration: none; text-align: center;">Edit</a>
